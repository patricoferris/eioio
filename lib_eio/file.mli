...
val pread : _ ro -> file_offset:Optint.Int63.t -> Bstruct.t list -> int
...
val pread_exact : _ ro -> file_offset:Optint.Int63.t -> Bstruct.t list -> unit
...
val pwrite_single : _ rw -> file_offset:Optint.Int63.t -> Bstruct.t list -> int
...
val pwrite_all : _ rw -> file_offset:Optint.Int63.t -> Bstruct.t list -> unit
